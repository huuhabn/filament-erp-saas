    ...
    public function panel(Panel $panel): Panel
    {
        ...
        return $panel
            ...
            ->renderHook(
                ...
                fn (): string => Blade::render('@livewire("language-switcher", ["isFlagsOnly" => false, "locales" => ["en", "ar", "vi"], "circular" => true, "labels" => ["en" => "English", "ar" => "العربية", "vi" => "Tiếng Việt"], "flags" => ["en" => "https://flagcdn.com/w40/gb.png", "ar" => "https://flagcdn.com/w40/sa.png", "vi" => "https://flagcdn.com/w40/vn.png"]])'),
            )
            ->authGuard('web')
