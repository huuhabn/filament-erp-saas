...
>
    <x-slot name="trigger">
        <div
            @class([
                'flex items-center justify-center aspect-square w-8 h-8 flex-shrink-0 language-switch-trigger text-primary-600 bg-primary-500/10',
                'rounded-full' => $isCircular,
                'rounded-lg' => ! $isCircular,
                'ring-gray-200 hover:ring-gray-300 dark:ring-gray-500 hover:dark:ring-gray-400' => $isFlagsOnly || $flag,
            ])
            x-tooltip="{
            ...
            @if (! app()->isLocale($locale))
                <button
                    ...
                    @class([
                        ...
                        'justify-center p-0' => $isFlagsOnly,
